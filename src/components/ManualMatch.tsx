...
//   onMatch,
// }: ManualMatchProps) {
//   const [selected  invoice_1, setSelected  invoice_1] = useState<string | null>(
//     null
//   );
...
//   const handleMatch = () => {
//     if (selected  invoice_1 && selectedinvoice_2) {
//       onMatch(selected  invoice_1, selectedinvoice_2);
//       setSelected  invoice_1(null);
...
//                         <button
//                           key={invoice.id}
//                           onClick={() => setSelected  invoice_1(invoice)}
//                           className={`w-full p-3 text-left rounded-lg border ${
//                             selected  invoice_1?.id === invoice.id
...
//                       {filteredInvoices
//                         .filter(
//                           (invoice) => invoice.id !== selected  invoice_1?.id
//                         )
//                         .map((invoice) => (
//                           <button
//                             key={invoice.id}
...
//                             className={`w-full p-3 text-left rounded-lg border ${
//                               selectedinvoice_2?.id === invoice.id
//                                 ? "border-blue-500 bg-blue-50 dark:bg-blue-900/50"
//                                 : "border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700"
//                             }`}
//                           >
...
//               type="button"
//               onClick={handleMatch}
//               disabled={!selected  invoice_1 || !selectedinvoice_2}
